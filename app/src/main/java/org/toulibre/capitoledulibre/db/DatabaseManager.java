package org.toulibre.capitoledulibre.db;
...
public class DatabaseManager {
	...
	public static final String ACTION_SCHEDULE_REFRESHED = "org.toulibre.capitoledulibre.action.SCHEDULE_REFRESHED";
	public static final String ACTION_ADD_BOOKMARK = "org.toulibre.capitoledulibre.action.ADD_BOOKMARK";
	public static final String EXTRA_EVENT_ID = "event_id";
	public static final String EXTRA_EVENT_START_TIME = "event_start";
	public static final String ACTION_REMOVE_BOOKMARKS = "org.toulibre.capitoledulibre.action.REMOVE_BOOKMARKS";
	public static final String EXTRA_EVENT_IDS = "event_ids";

	private static final Uri URI_TRACKS = Uri.parse("sqlite://org.toulibre.capitoledulibre/tracks");
	private static final Uri URI_EVENTS = Uri.parse("sqlite://org.toulibre.capitoledulibre/events");
	...
	public int getYear() {
		...
		Calendar cal = Calendar.getInstance(DateUtils.getFrenchTimeZone(), Locale.US);
