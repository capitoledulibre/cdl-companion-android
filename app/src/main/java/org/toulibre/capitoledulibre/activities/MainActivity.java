...
import org.toulibre.capitoledulibre.api.Api;
import org.toulibre.capitoledulibre.db.DatabaseManager;
import org.toulibre.capitoledulibre.fragments.BookmarksListFragment;
import org.toulibre.capitoledulibre.fragments.LiveFragment;
import org.toulibre.capitoledulibre.fragments.MapFragment;
import org.toulibre.capitoledulibre.fragments.PersonsListFragment;
import org.toulibre.capitoledulibre.fragments.TracksFragment;
import org.toulibre.capitoledulibre.widgets.AdapterLinearLayout;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final BroadcastReceiver scheduleDownloadProgressReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            progressBar.setProgress(intent.getIntExtra(Api.EXTRA_PROGRESS, 0));
        }
    };
    ...
    private final BroadcastReceiver scheduleDownloadResultReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            int result = intent.getIntExtra(Api.EXTRA_RESULT, Api.RESULT_ERROR);
            String message;
            switch (result) {
                case Api.RESULT_ERROR:
                    message = getString(R.string.schedule_loading_error);
                    break;
                case Api.RESULT_UP_TO_DATE:
    ...
    protected void onStart() {
        ...
        lbm.registerReceiver(scheduleDownloadProgressReceiver, new IntentFilter(Api.ACTION_DOWNLOAD_SCHEDULE_PROGRESS));
        lbm.registerReceiver(scheduleDownloadResultReceiver, new IntentFilter(Api.ACTION_DOWNLOAD_SCHEDULE_RESULT));
    ...
    private static class DownloadScheduleAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... args) {
            Api.downloadSchedule(appContext);
            return null;
        }
    }
